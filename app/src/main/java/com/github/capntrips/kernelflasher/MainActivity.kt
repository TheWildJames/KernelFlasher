                ...
                if (!mainViewModel.hasError) {
                    ...
                    NavHost(navController = navController, startDestination = "main") {
                        ...
                        if (mainViewModel.isAb) {
                            ...
                            composable("slot_a/flash/image_dd", content = slotFlashContentA)
                            composable("slot_a/flash/image_dd/flash", content = slotFlashContentA)
                            ...
                            composable("slot_b/flash/image_dd", content = slotFlashContentB)
                            composable("slot_b/flash/image_dd/flash", content = slotFlashContentB)
                            ...
                            composable("slot/flash/image_dd", content = slotFlashContent)
                            composable("slot/flash/image_dd/flash", content = slotFlashContent)
